...
var ASM_CONSTS = {
  92840: () => { if (document.fullscreenElement) return 1; },  
 92886: () => { return Module.canvas.width; },  
 92918: () => { return parseInt(Module.canvas.style.width); },  
 92966: () => { document.exitFullscreen(); },  
 92993: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93066: () => { if (document.fullscreenElement) return 1; },  
 93112: () => { return Module.canvas.width; },  
 93144: () => { return screen.width; },  
 93169: () => { document.exitFullscreen(); },  
 93196: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93329: () => { return window.innerWidth; },  
 93355: () => { return window.innerHeight; },  
 93382: () => { if (document.fullscreenElement) return 1; },  
 93428: () => { return Module.canvas.width; },  
 93460: () => { return parseInt(Module.canvas.style.width); },  
 93508: () => { if (document.fullscreenElement) return 1; },  
 93554: () => { return Module.canvas.width; },  
 93586: () => { return screen.width; },  
 93611: () => { return window.innerWidth; },  
 93637: () => { return window.innerHeight; },  
 93664: () => { if (document.fullscreenElement) return 1; },  
 93710: () => { return Module.canvas.width; },  
 93742: () => { return screen.width; },  
 93767: () => { document.exitFullscreen(); },  
 93794: () => { if (document.fullscreenElement) return 1; },  
 93840: () => { return Module.canvas.width; },  
 93872: () => { return parseInt(Module.canvas.style.width); },  
 93920: () => { document.exitFullscreen(); },  
 93947: ($0) => { Module.canvas.style.opacity = $0; },  
 93985: () => { return screen.width; },  
 94010: () => { return screen.height; },  
 94036: () => { return window.screenX; },  
 94063: () => { return window.screenY; },  
 94090: () => { return window.devicePixelRatio; },  
 94126: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94179: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94230: () => { Module.canvas.style.cursor = 'none'; },  
 94267: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94523: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94574: () => { if (document.fullscreenElement) return 1; },  
 94620: () => { return window.innerWidth; },  
 94646: () => { return window.innerHeight; },  
 94673: () => { if (document.pointerLockElement) return 1; }
};
